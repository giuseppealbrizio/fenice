...
function serializeNote(note: NoteDocument): Note {
  ...
  return {
    ...
    isPinned: json['isPinned'] as boolean,
...
function buildNoteFilter(params: NoteQuery): Record<string, unknown> {
  ...
  if (params.createdAfter || params.createdBefore) {
    ...
    if (params.createdAfter) {
      (filter['createdAt'] as Record<string, unknown>)['$gte'] = new Date(params.createdAfter);
    }
    if (params.createdBefore) {
      (filter['createdAt'] as Record<string, unknown>)['$lte'] = new Date(params.createdBefore);
    }
  }
